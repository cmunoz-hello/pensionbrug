...
st.success(f"✅ Projected AOW at retirement (age {aow['retirement_age']}): **€{aow['aow_annual_single']:,}/year** (€{aow['aow_monthly_single']:,}/month) — based on {aow['total_years_insured']} insured years ({aow['aow_percentage']}% of full benefit)")
...
st.caption(f"Based on {gap_data['num_simulations']:,} simulations of DC investment return scenarios (post-WTP)")
